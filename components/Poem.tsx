...
function FloralBottom({ className = "" }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true">
      <path
        d="M100 100 Q95 70 80 50 Q65 30 50 10"
        stroke="#8B5A2B"
        strokeWidth="1"
        strokeLinecap="round"
        fill="none"
      ...
      />
      <path
        d="M100 100 Q105 70 120 50 Q135 30 150 10"
        stroke="#8B5A2B"
        strokeWidth="1"
        strokeLinecap="round"
        fill="none"
    ...
    <motion.section
      ...
      <motion.div
        ...
        <div
          ...
          style={{
            background: "linear-gradient(90deg, #c9a96e, #a8884e, #c9a96e)",
          }}
        />
